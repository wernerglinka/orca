...
(function () {
  ...
  const softScroll = function ($) {
    'use strict'; // filter handling for a /dir/ OR /indexordefault.page
  ...
  }(jQuery); // function to attach a class to the body element when the hamburger is touched/clicked
  ...
  }(jQuery); // function to manage toTop icon visibility
  ...
  }(jQuery); // function to manage the about prose section
